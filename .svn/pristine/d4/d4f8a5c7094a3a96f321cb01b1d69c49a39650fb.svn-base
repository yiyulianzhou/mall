...
// Select All option
    $('.multiselect-select-area').multiselect({
        includeSelectAllOption: true,
        onChange: function() {
            $.uniform.update();
        },
	   allSelectedText: '已选择全部地区，共',
	...
	// Clickable optgroups
    $('.multiselect-clickable-groups-all').multiselect({
       ...
       numberDisplayed: 9,
	   templates: {
            ul: '<ul class="multiselect-container dropdown-menu mb50"></ul>'
        }
    });
